# HAProxy 2.4.14 for CentOS 7

This repository contains necessary build files of HAProxy 2.4.14 with no support and no expectation of stability. The recommended way of using the repository is to build and test your own packages.

# HAProxy 2.4.2 for CentOS 7

This repository contains necessary build files of HAProxy 2.4.2 with no support and no expectation of stability. The recommended way of using the repository is to build and test your own packages.
...
NOTE: To build HAProxy 2.4.2, you will need LUA >= 5.3. On the officials CentOS 7 repositories, the latest version is 5.1.4. It is why we need to do this:

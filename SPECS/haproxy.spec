...
%changelog
* Wed Oct 5 2022 locobastos <bastien.thierry.martin@gmail.com> 2.5.9-1
Add build parameter to use Promotheus (USE_PROMEX=1)
Update specfile to 2.5.9

* Thu Sep 1 2022 locobastos <bastien.thierry.martin@gmail.com> 2.5.8-1
Update specfile to 2.5.8

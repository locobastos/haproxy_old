...
Source0:          http://www.haproxy.org/download/2.6/src/haproxy-%{version}.tar.gz
...
%changelog
* Wed Oct 5 2022 locobastos <bastien.thierry.martin@gmail.com> 2.6.6-1
Add build parameter to use Promotheus (USE_PROMEX=1)
Update specfile to 2.6.6

* Thu Sep 1 2022 locobastos <bastien.thierry.martin@gmail.com> 2.6.4-1
Update specfile to 2.6.4
